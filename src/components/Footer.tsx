        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Discover extraordinary travel experiences powered by decentralized technology and seamless crypto payments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/categories/adventure" className="text-gray-400 hover:text-white transition-colors">Adventure</Link></li>
              <li><Link to="/categories/cultural" className="text-gray-400 hover:text-white transition-colors">Cultural</Link></li>
              <li><Link to="/categories/food-drink" className="text-gray-400 hover:text-white transition-colors">Food & Drink</Link></li>
              <li><Link to="/categories/nature" className="text-gray-400 hover:text-white transition-colors">Nature</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/host/resources" className="text-gray-400 hover:text-white transition-colors">Resources</Link></li>
              <li><Link to="/host/community" className="text-gray-400 hover:text-white transition-colors">Community</Link></li>
              <li><Link to="/host/responsible-hosting" className="text-gray-400 hover:text-white transition-colors">Responsible Hosting</Link></li>
            </ul>
          </div>
